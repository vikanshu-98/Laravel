...
<table class="table mt-5" >
    ...
    @foreach($data as $key)
        ...
        <tr>
            ...
            <td> 
                  <a name="" id="" class="btn btn-primary" href="{{url('/restore')}}/{{$key->customer_id }} " role="button">Restore</a>
                  <a name="" id="" class="btn btn-danger" href="{{url('/permanentdelete')}}/{{$key->customer_id }}" role="button">Delete</a> 
             </td>
        </tr>
    @endforeach
    </tbody>
